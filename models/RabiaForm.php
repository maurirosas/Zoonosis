    ...
    public function rules()
{
    return [
        ...
        [['sedes', 'distrito', 'especie', 'tipo_animal', 'vacuna_antirrabica', 'presento_carnet', 'fecha_ult_vacuna', 'marca_vacuna', 'sintomas_clinicos', 'especificar', 'diagnostico_presuntivo', 'antecedentes_mordeduras', 'n_de_personas_mordidas', 'n_especie_animales_mordidos', 'circunstancias_mordidos', 'tecnica', 'tipo_muestra', 'fecha_muestra', 'fecha_envio', 'fecha_recepcion', 'nombre_remitente', 'cargo', 'telefono', 'n_fax', 'celular', 'observaciones', 'nombre_responsable'], 'safe'],
    ];
}
